    ...
    override fun setListener() {
        ...
        with(binding) {
            ...
            btnUploadProduct.setOnClickListener {
                val productName = productName.extract()
                val productDescription = productDescription.extract()
                val productPrice = productPrice.extract()
                val productQuantity = productQuantity.extract()
